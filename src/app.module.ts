...
@Module({
  imports: [SharedModule, CoreModule, UsersModule, PrismaModule, AuthModule, GamesModule, TeamsModule, GameMapsModule, TournamentsModule, MatchesModule, RankingModule],
